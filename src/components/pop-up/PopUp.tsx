...
const PopUpModal = () => {
  ...
  return (
    <div className={`fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-80 ${isOpenPopUpModal ? 'block' : 'hidden'}`} onClick={handleClosePopUpModal}>
      <div className="bg-blueBg flex flex-col lg:max-w-[500px] max-h-[80vh] min-h-[10vh] overflow-y-auto w-full rounded-md gap-5 p-6 relative max-w-[500px]" onClick={e => e.stopPropagation()}>
        <img
